...
class OrderResourceIT {
    ...
    private static final String DEFAULT_ORDER_NR = "AAAAAAAAAAAAA";
    private static final String UPDATED_ORDER_NR = "BBBBBBBBBBBBB";
    ...
    public static Order createEntity() {
        Order order = new Order().orderNr(DEFAULT_ORDER_NR).quantity(DEFAULT_QUANTITY).total(DEFAULT_TOTAL);
        // Add required entity
        Product product;
    ...
    public static Order createUpdatedEntity() {
        Order order = new Order().orderNr(UPDATED_ORDER_NR).quantity(UPDATED_QUANTITY).total(UPDATED_TOTAL);
        // Add required entity
        Product product;
    ...
    @Test
    void checkOrderNrIsRequired() throws Exception {
    ...
    void putExistingOrder() throws Exception {
        ...
        updatedOrder.orderNr(UPDATED_ORDER_NR).quantity(UPDATED_QUANTITY).total(UPDATED_TOTAL);
    ...
    void partialUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.orderNr(UPDATED_ORDER_NR).total(UPDATED_TOTAL);
    ...
    void fullUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.orderNr(UPDATED_ORDER_NR).quantity(UPDATED_QUANTITY).total(UPDATED_TOTAL);
